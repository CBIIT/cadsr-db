CREATE OR REPLACE TYPE SBREXT."DE_VALID_VALUE_T" as object(
...
GRANT EXECUTE, DEBUG ON SBREXT.DE_VALID_VALUE_T TO DER_USER;
...
GRANT EXECUTE, DEBUG ON SBREXT.DE_VALID_VALUE_LIST_T TO DER_USER;


/* Formatted on 8/7/2014 1:20:15 PM (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW SBREXT.DE_CDE_EXCEL_GENERATOR_VIEW
(
   DE_IDSEQ,
   CDE_ID,
   LONG_NAME,
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON SBREXT.DE_CDE_EXCEL_GENERATOR_VIEW TO CDEBROWSER;

GRANT DELETE, INSERT, SELECT, UPDATE ON SBREXT.DE_CDE_EXCEL_GENERATOR_VIEW TO DER_USER;

DROP SYNONYM CDEBROWSER.DE_CDE_EXCEL_GENERATOR_VIEW;

CREATE SYNONYM CDEBROWSER.DE_CDE_EXCEL_GENERATOR_VIEW FOR SBREXT.DE_CDE_EXCEL_GENERATOR_VIEW;
