...
insert into  SBREXT.MDSR_DUP_VM_ERR VALUES('MDSR_DUP_VM_ERR', 'SBR.DESIGNATIONS','C2',j.FIN_IDSEQ,j.FIN_VM,v_errm,sysdate );
EXCEPTION
    WHEN others THEN
       V_error := substr(SQLERRM,1,200);     
      insert into  SBREXT.MDSR_DUP_VM_ERR VALUES('MDSR_DUP_VM_ERR', 'DESIGNATIONS','C2',j.VM_IDSEQ,'Last insert',V_error,sysdate );
  commit;
end;
end loop;
end;
...
insert into  SBREXT.MDSR_DUP_VM_ERR VALUES('MDSR_DUP_VM_ERR', 'SBR.DEFINITIONS','C3',j.FIN_IDSEQ,j.FIN_VM,v_errm,sysdate );
EXCEPTION
    WHEN others THEN
       V_error := substr(SQLERRM,1,200);     
      insert into  SBREXT.MDSR_DUP_VM_ERR VALUES('MDSR_DUP_VM_ERR', 'DEFINITIONS','C3',j.VM_IDSEQ,'Last insert',V_error,sysdate );
  commit;
end;
end loop;
end;
...
for j in C4 loop
begin
v_errm:='CS_CSI '||j.CS_CSI_IDSEQ||'is not created designation of VM:'||j.FIN_VM||' from VM:'||j.VM_ID||' and DES  '||j.DESIG_IDSEQ ||' and DES_NAME:'||j.NAME;
--v_errm:='DEFINITION of VM:'||j.VM_IDSEQ||'and DEFINITIONS for DEFINITION '||j.DEFINITION||' DEFIN_IDSEQ:' ||j.DEFIN_IDSEQ ||'  not created for VM:'||j.FIN_VM;
insert into  SBREXT.MDSR_DUP_VM_ERR VALUES('MDSR_DUP_VM_ERR', 'SBREXT.ac_att_cscsi_ext for DES','C3',j.FIN_IDSEQ,j.FIN_VM,v_errm,sysdate );
EXCEPTION
    WHEN others THEN
       V_error := substr(SQLERRM,1,200);     
      insert into  SBREXT.MDSR_DUP_VM_ERR VALUES('MDSR_DUP_VM_ERR', 'DEFINITIONS','C3',j.VM_IDSEQ,'Last insert',V_error,sysdate );
...
v_errm:='DEFINITION of VM:'||j.VM_IDSEQ||'and DEFINITIONS for DEFINITION '||j.DEFINITION||' DEFIN_IDSEQ:' ||j.DEFIN_IDSEQ ||'  not created for VM:'||j.FIN_VM;
insert into  SBREXT.MDSR_DUP_VM_ERR VALUES('MDSR_DUP_VM_ERR', 'SBR.DEFINITIONS','C5',j.FIN_IDSEQ,j.FIN_VM,v_errm,sysdate );
EXCEPTION
    WHEN others THEN
       V_error := substr(SQLERRM,1,200);     
      insert into  SBREXT.MDSR_DUP_VM_ERR VALUES('MDSR_DUP_VM_ERR', 'DEFINITIONS','C5',j.VM_IDSEQ,'Last insert',V_error,sysdate );
  commit;
end;
end loop;
end;
