...
commit;
 ...
 INSERT INTO SBREXT.MDSR_VM_DUP_REF
(FIN_VM,FIN_IDSEQ ,VM_ID,VM_IDSEQ,CONCEPTS_CODE,CONCEPTS_NAME,LONG_NAME,CONDR_IDSEQ, PROC )
 select   FIN_VM ,VM_IDSEQ FIN_IDSEQ,VM_ID,VM_IDSEQ, CONCEPTS_CODE,'SYNONYM',VM_NAME,CONDR_IDSEQ,'FINAL'
FROM
...
(FIN_VM,FIN_IDSEQ ,VM_ID,VM_IDSEQ,CONCEPTS_CODE,CONCEPTS_NAME,LONG_NAME,CONDR_IDSEQ )
 select   FIN_VM ,VM_IDSEQ FIN_IDSEQ,VM_ID,VM_IDSEQ, CONCEPTS_CODE,'SYNONYM',long_NAME,CONDR_IDSEQ
 FROM
 ...
 FROM SBREXT.MDSR_VM_DUP_REF WHERE proc is null and CONCEPTS_NAME like 'SYNONYM%')
 ORDER BY CONCEPTS_CODE,FIN_VM,VM_ID desc;
 commit;
 ----Final VM records with no match to concepts/synonyms
  
 INSERT INTO SBREXT.MDSR_VM_DUP_REF
(FIN_VM,FIN_IDSEQ ,VM_ID,VM_IDSEQ,CONCEPTS_CODE,LONG_NAME,CONDR_IDSEQ, PROC )
...
WHERE PROC='FINAL' and instr(CONCEPTS_CODE,'C45255')=0
AND instr(CONCEPTS_CODE,':')>0
and CONCEPTS_NAME is null;
