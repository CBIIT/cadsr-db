...
SELECT VM.CONDR_IDSEQ,NAME,LONG_NAME_AG,LONG_NAME
FROM  SBR.VALUE_MEANINGS VM,
...
and instr(NAME,'C45255')=0
order by VM.CONDR_IDSEQ,LONG_NAME;
...
AND  VM.CONDR_IDSEQ=DR.CONDR_IDSEQ
AND DR.name=c.preferred_name
AND DR.NAME not in ('C18031','C28427','C25450','C25250','C25484','C102844','C61376','C25258','C74601','C15191','C49161','C82650','C25666','C106146','C18002','C2265','C2322','C25342','C25458','C25594','C25640','C28343','C28554','C3114','C318','C3262','C37987','C40412','C42620',
'C48282','C48500','C48813','C50764','C53279','C62220','C62559','C63351','C86024','C88791','C900','C90025','C91215','C94226')
AND instr(trim(C.LONG_NAME),' ')=0
AND instr(trim(VM.LONG_NAME),' ')=0
AND instr(dr.name,':')=0
and UPPER(VM.ASL_NAME) not like '%RETIRED%'
...
AND  VM.CONDR_IDSEQ=DR.CONDR_IDSEQ
AND DR.name=c.preferred_name
AND DR.NAME not in ('C18031','C28427','C25450','C25250','C25484','C102844','C61376','C25258','C74601','C15191','C49161','C82650','C25666','C106146')
AND instr(trim(C.LONG_NAME),' ')=0
AND instr(trim(VM.LONG_NAME),' ')=0
AND instr(dr.name,':')=0
and UPPER(VM.ASL_NAME) not like '%RETIRED%'
