...
SPOOL CDEBROWSER-873.log
CREATE OR REPLACE package MDSR_CDEBROWSER is

FUNCTION get_concept_order(p_condr_idseq in varchar2) return varchar2;
end MDSR_CDEBROWSER;
/
CREATE OR REPLACE package body MDSR_CDEBROWSER is
...
/
CREATE OR REPLACE SYNONYM DER_USER.DE_CDE1_XML_GENERATOR_VIEW FOR DE_CDE1_XML_GENERATOR_VIEW
/
