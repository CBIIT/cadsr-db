...
where INSTR(MEANING_TEXT,'&'||'gt;')>0 or
 ...
 INSTR(DESCRIPTION_TEXT,'&'||'#x61;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x62;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x63;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x64;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x69;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x6a;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x70;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x72;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x73;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x74;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x76;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x3a;')>0 or
 INSTR(DESCRIPTION_TEXT,'&'||'#x28;')>0 or 
 INSTR(DESCRIPTION_TEXT,'&'||'#x29;')>0 or 
 INSTR(DESCRIPTION_TEXT,'&'||'#8322;')>0 or 
 INSTR(MEANING_TEXT,'&'||'#x61;')>0 or
INSTR(MEANING_TEXT,'&'||'#x62;')>0 or
INSTR(MEANING_TEXT,'&'||'#x63;')>0 or
 INSTR(MEANING_TEXT,'&'||'#x64;')>0 or
 INSTR(MEANING_TEXT,'&'||'#x69;')>0 or
 INSTR(MEANING_TEXT,'&'||'#x6a;')>0 or
 INSTR(MEANING_TEXT,'&'||'#x70;')>0 or
 INSTR(MEANING_TEXT,'&'||'#x72;')>0 or
 INSTR(MEANING_TEXT,'&'||'#x73;')>0 or
 INSTR(MEANING_TEXT,'&'||'#x74;')>0 or
 INSTR(MEANING_TEXT,'&'||'#x76;')>0 or
 INSTR(MEANING_TEXT,'&'||'#x3a;')>0 or
 INSTR(MEANING_TEXT,'&'||'#x28;')>0 or 
 INSTR(MEANING_TEXT,'&'||'#x29;')>0 or 
...
UPDATE VALID_VALUES_ATT_EXT set MEANING_TEXT=replace(MEANING_TEXT,'&'||'#181;','µ') ,                              
 ...
 where INSTR(MEANING_TEXT,'&'||'#181;')>0 or
  ...
  update VALID_VALUES_ATT_EXT  set  date_modified=v_date, modified_by='DWARZEL',
...
INSTR(LONG_NAME,'&'||'#x63;')>0 or
 ...
 INSTR(LONG_NAME,'&'||'#x69;')>0 or
 INSTR(LONG_NAME,'&'||'#x6a;')>0 or
 INSTR(LONG_NAME,'&'||'#x70;')>0 or
 INSTR(LONG_NAME,'&'||'#x72;')>0 or
 ...
 INSTR(PREFERRED_DEFINITION,'&'||'#x61;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#x62;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#x63;')>0 or
 INSTR(PREFERRED_DEFINITION,'&'||'#x64;')>0 or
 INSTR(PREFERRED_DEFINITION,'&'||'#x69;')>0 or
 INSTR(PREFERRED_DEFINITION,'&'||'#x6a;')>0 or
 INSTR(PREFERRED_DEFINITION,'&'||'#x70;')>0 or
 INSTR(PREFERRED_DEFINITION,'&'||'#x72;')>0 or
 INSTR(PREFERRED_DEFINITION,'&'||'#x73;')>0 or
 INSTR(PREFERRED_DEFINITION,'&'||'#x74;')>0 or
 INSTR(PREFERRED_DEFINITION,'&'||'#x76;')>0 or
 ...
 update QUEST_CONTENTS_EXT set  date_modified=v_date, modified_by='DWARZEL',
...
where INSTR(short_meaning,'&'||'gt;')>0 or
 ...
 INSTR(short_meaning,'&'||'#x61;')>0 or
 INSTR(short_meaning,'&'||'#x62;')>0 or
 INSTR(short_meaning,'&'||'#x63;')>0 or
 INSTR(short_meaning,'&'||'#x64;')>0 or
 
 INSTR(short_meaning,'&'||'#x69;')>0 or
 INSTR(short_meaning,'&'||'#x6a;')>0 or
 INSTR(short_meaning,'&'||'#x70;')>0 or
 INSTR(short_meaning,'&'||'#x72;')>0 or
 INSTR(short_meaning,'&'||'#x73;')>0 or
 INSTR(short_meaning,'&'||'#x74;')>0 or
 INSTR(short_meaning,'&'||'#x76;')>0 or
 INSTR(short_meaning,'&'||'#x3a;')>0 or
 INSTR(short_meaning,'&'||'#x28;')>0 or 
 INSTR(short_meaning,'&'||'#x29;')>0 or 
 INSTR(short_meaning,'&'||'#8322;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x61;')>0 or
INSTR(MEANING_DESCRIPTION,'&'||'#x62;')>0 or
INSTR(MEANING_DESCRIPTION,'&'||'#x63;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x64;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x69;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x6a;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x70;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x72;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x73;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x74;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x76;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x3a;')>0 or
 INSTR(MEANING_DESCRIPTION,'&'||'#x28;')>0 or 
 INSTR(MEANING_DESCRIPTION,'&'||'#x29;')>0 or 
...
INSTR(MEANING_DESCRIPTION,'&'||'#181;')>0  ;  
 ...
 update PERMISSIBLE_VALUES  set  date_modified=v_date, modified_by='DWARZEL',
...
INSTR(short_meaning,'&'||'#x63;')>0 or
 ...
 INSTR(DESCRIPTION,'&'||'#x69;')>0 or
 INSTR(DESCRIPTION,'&'||'#x6a;')>0 or
 INSTR(DESCRIPTION,'&'||'#x70;')>0 or
 INSTR(DESCRIPTION,'&'||'#x72;')>0 or
 INSTR(DESCRIPTION,'&'||'#x73;')>0 or
 INSTR(DESCRIPTION,'&'||'#x74;')>0 or
 INSTR(DESCRIPTION,'&'||'#x76;')>0 or
 INSTR(DESCRIPTION,'&'||'#x3a;')>0 or
 INSTR(DESCRIPTION,'&'||'#x28;')>0 or 
 INSTR(DESCRIPTION,'&'||'#x29;')>0 or 
...
/
CREATE OR REPLACE PROCEDURE SBR.CT_FIX_VALUE_DOMAINS IS
v_date  date  ;
V_sdate date:=sysdate;
errmsg VARCHAR2(2000):='Non';
/******************************************************************************
...
/*update SBR.VALUE_DOMAINS SET LONG_NAME =SUBSTR (LONG_NAME, 1, 250)||'...'
where LENGTH (LONG_NAME) > 255
and (
INSTR(LONG_NAME,'&'||'gt;')>0 or
INSTR(LONG_NAME,'&'||'lt;')>0 or
...
INSTR(PREFERRED_DEFINITION,'&'||'#x63;')>0 or
 ...
 update VALUE_DOMAINS set  date_modified=v_date, modified_by='DWARZEL',
LONG_NAME= replace(LONG_NAME,'src=&#x6a;&#x61;&#x76;&#x61;&#x73;&#x63;&#x72;&#x69;&#x70;&#x74;&#x3a;alert&#x28;8481&#x29;','src=javascript:alert(8481);')
where INSTR(LONG_NAME,'src=&#x6a;&#x61;&#x76;&#x61;&#x73;&#x63;&#x72;&#x69;&#x70;&#x74;&#x3a;alert&#x28;8481&#x29;')>0 ;
...
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'gt;','>') ,   
PREFERRED_NAME=replace(PREFERRED_NAME,'&'||'gt;','>') ,  
LONG_NAME=replace(LONG_NAME,'&'||'gt;','>') ,                        
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'gt;')>0 
...
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#62;','>') , 
PREFERRED_NAME=replace(PREFERRED_NAME,'&'||'#62;','>') ,  
LONG_NAME=replace(LONG_NAME,'&'||'#62;','>') ,                               
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'#62;')>0 
...
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'lt;','<') ,  
PREFERRED_NAME=replace(PREFERRED_NAME,'&'||'lt;','<') ,
LONG_NAME=replace(LONG_NAME,'&'||'lt;','<') ,                              
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'lt;')>0
...
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#60;','<') , 
PREFERRED_NAME=replace(PREFERRED_NAME,'&'||'#60;','<') , 
LONG_NAME=replace(LONG_NAME,'&'||'#60;','<') ,                               
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'#60;')>0 
...
--3  replace '&amp;' by '<'
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'amp;','&') ,  
PREFERRED_NAME=replace(PREFERRED_NAME,'&'||'amp;','&') ,  
LONG_NAME=replace(LONG_NAME,'&'||'amp;','&') ,                           
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'amp;')>0 
or  INSTR(LONG_NAME,'&'||'amp;')>0 ;
--3  replace '&amp;' by '<'
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#38;','&') ,
PREFERRED_NAME=replace(PREFERRED_NAME,'&'||'#38;','&') , 
LONG_NAME=replace(LONG_NAME,'&'||'#38;','&') ,                              
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'#38;')>0 
...
---   replace &#32; by '  '    
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#32;',' '), 
...
---   replace &#33; by !        
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#33;','!'), 
...
---   replace &#34; by "       
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#34;','"'), 
...
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#35;','#'),  
...
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#36;','$'), 
...
or  INSTR(LONG_NAME,'&'||'#36;')>0 ; 
--6    %   &#37;          
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#37;','%'), 
...
--6    &#39;    single quote      
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#39;',''''), 
...
-- 7   (   &#40; 
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#40;','('),
...
or  INSTR(LONG_NAME,'&'||'#40;')>0 ;
--    )   &#41; 
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#41;',')'),
...
or  INSTR(LONG_NAME,'&'||'#41;')>0 ;
--    *   &#42; 
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#42;','*'),
...
or  INSTR(LONG_NAME,'&'||'#42;')>0 ;
--    +    &#43; 
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#43;','+'),  
...
--    -    &#45; 
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#45;','-'),
...
--    '.'    &#46; 
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#46;','.'),  
...
or  INSTR(LONG_NAME,'&'||'#46;')>0 ;
--    /    &#47; 
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#47;','/'),
...
or  INSTR(LONG_NAME,'&'||'#47;')>0 ;
--    =    &#61;        
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#61;','=') ,
...
--    ?   &#63;        
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#63;','?') ,
...
--    @  &#64;        
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#64;','@') ,
...
--   [   &#91;  opening bracket      
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#91;','[') ,
...
or  INSTR(LONG_NAME,'&'||'#91;')>0 ;
--   \   &#92;  backslash      
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#92;','\') ,
...
--  ]   &#93;  closing bracket      
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#93;',']') ,
...
--  ^  &#94;  caret - circumflex     
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#94;','^') ,
...
--  {  &#123;  opening brace     
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#123;','{') ,
LONG_NAME=replace(LONG_NAME,'&'||'#123;','{') , 
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'#123;')>0 
or  INSTR(LONG_NAME,'&'||'#123;')>0 ;  
...
--  |  &#1234;  opening brace     
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#124;','|') ,
...
--  }  &#125;  closing brace    
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#125;','}') ,
...
or  INSTR(LONG_NAME,'&'||'#125;')>0 ;
--  ~  &#126;  equivalency sign - tilde    
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#126;','~') ,
...
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#191;','') ,
LONG_NAME=replace(LONG_NAME,'&'||'#191;','') ,  
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'#191;')>0 
or  INSTR(LONG_NAME,'&'||'#191;')>0 ;  
...
--  °  &#176;    degree sign
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#176;','°') ,
LONG_NAME=replace(LONG_NAME,'&'||'#176;','°') , 
       date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'#176;')>0 
...
--  ±  &#177;  plus-or-minus sign   
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#177;','±') ,
LONG_NAME=replace(LONG_NAME,'&'||'#177;','±') ,  
 date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'#177;')>0 
or  INSTR(LONG_NAME,'&'||'#177;')>0 ;  
--  ² &#178;  superscript two - squared    
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#178;','²') ,
LONG_NAME=replace(LONG_NAME,'&'||'#178;','²') ,
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'#178;')>0 
or  INSTR(LONG_NAME,'&'||'#178;')>0 ;            
--  ³  &#179;  superscript three - cubed   
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#179;','³') ,
LONG_NAME=replace(LONG_NAME,'&'||'#179;','³') ,
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'#179;')>0 
or  INSTR(LONG_NAME,'&'||'#179;')>0 ;  
...
--  µ  &#181;   micro sign  
UPDATE VALUE_DOMAINS set PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#181;','µ') ,
LONG_NAME=replace(LONG_NAME,'&'||'#181;','µ') , 
date_modified=v_date, modified_by='DWARZEL'
where INSTR(PREFERRED_DEFINITION,'&'||'#181;')>0
or  INSTR(LONG_NAME,'&'||'#181;')>0;  
...
INSTR(LONG_NAME,'&'||'#8200;')>0 ;
 ...
 commit;  
    ...
    WHEN OTHERS THEN   
       errmsg := substr(SQLERRM,1,2000);
         dbms_output.put_line('errmsg  - '||errmsg);
        insert into SBREXT.CT_FB_SPCHAR_ERROR_LOG VALUES('CT_FIX_VALUE_DOMAINS',   sysdate ,errmsg);
        
     commit; 
END CT_FIX_VALUE_DOMAINS;
/
CREATE OR REPLACE PROCEDURE SBR.CT_FIX_CD_VMS IS
v_date  date  ;
V_sdate date:=sysdate;
errmsg VARCHAR2(2000):='Non';
/******************************************************************************
...
INSTR(DESCRIPTION,'&'||'#x63;')>0 or
 ...
 INSTR(DESCRIPTION,'&'||'#8322;')>0;
--1  replace '&gt;' by '>'     
UPDATE SBR.CD_VMS set short_meaning=replace(short_meaning,'&'||'gt;','>') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'gt;','>'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'gt;')>0 or
INSTR(DESCRIPTION,'&'||'gt;')>0 ;
         
UPDATE SBR.CD_VMS set short_meaning=replace(short_meaning,'&'||'#62;','>') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#62;','>'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#62;')>0 or
INSTR(DESCRIPTION,'&'||'#62;')>0 ;
--2  replace '&lt;' by '<'

UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'lt;','<') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'lt;','<'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'lt;')>0 or
INSTR(DESCRIPTION,'&'||'lt;')>0 ;
         
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#60;','<') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#60;','<'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#60;')>0 or
INSTR(DESCRIPTION,'&'||'#60;')>0 ;        
         
--3  replace '&amp;' by '<'
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'amp;','&') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'amp;','&'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'amp;')>0 or
INSTR(DESCRIPTION,'&'||'amp;')>0  ;
         
--3  replace '&amp;' by '<'
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#38;','&') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#38;','&'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#38;')>0 or
INSTR(DESCRIPTION,'&'||'#38;')>0  ;        
         
 
---   replace &#32; by '  '    
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#32;',' '),
DESCRIPTION=replace(DESCRIPTION,'&'||'#32;',' '),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#32;')>0 or
INSTR(DESCRIPTION,'&'||'#32;')>0 ;   
                    
---   replace &#33; by !        
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#33;','!'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#33;','!'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#33;')>0 or
INSTR(DESCRIPTION,'&'||'#33;')>0 ;    
         
---   replace &#34; by "       
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#34;','"'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#34;','"'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#34;')>0 or
INSTR(DESCRIPTION,'&'||'#34;')>0 ;                  
         
-- 4   $    &#35; 
           
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#35;','#'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#35;','#'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#35;')>0 or
INSTR(DESCRIPTION,'&'||'#35;')>0  ; 
           
-- 5   $    &#36; 
           
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#36;','$'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#36;','$'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#36;')>0 or
INSTR(DESCRIPTION,'&'||'#36;')>0 ; 
--6    %   &#37;          
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#37;','%'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#37;','%'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#37;')>0 or
INSTR(DESCRIPTION,'&'||'#37;')>0 ; 
         
--6    &#39;    single quote      
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#39;',''''),
DESCRIPTION=replace(DESCRIPTION,'&'||'#39;',''''),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#39;')>0 or
INSTR(DESCRIPTION,'&'||'#39;')>0 ;         
             
           
-- 7   (   &#40; 
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#40;','('),
DESCRIPTION=replace(DESCRIPTION,'&'||'#40;','('),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#40;')>0 or
INSTR(DESCRIPTION,'&'||'#40;')>0 ;
--    )   &#41; 
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#41;',')'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#41;',')'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#41;')>0 or
INSTR(DESCRIPTION,'&'||'#41;')>0 ;          
                             
--    *   &#42; 
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#42;','*'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#42;','*'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#42;')>0 or
INSTR(DESCRIPTION,'&'||'#42;')>0 ;  
           
--    +    &#43; 
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#43;','+'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#43;','+'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#43;')>0 or
INSTR(DESCRIPTION,'&'||'#43;')>0 ;  
           
--    -    &#45; 
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#45;','-'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#45;','-'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#45;')>0 or
INSTR(DESCRIPTION,'&'||'#45;')>0 ;     
         
            
--    '.'    &#46; 
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#46;','.'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#46;','.'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#46;')>0 or
INSTR(DESCRIPTION,'&'||'#46;')>0 ;            
         
--    /    &#47; 
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#47;','/'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#47;','/'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#47;')>0 or
INSTR(DESCRIPTION,'&'||'#47;')>0  ;
--    =    &#61;        
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#61;','=') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#61;','='),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#61;')>0 or
INSTR(DESCRIPTION,'&'||'#61;')>0  ; 
           
--    ?   &#63;        
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#63;','?') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#63;','?'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#63;')>0 or
INSTR(DESCRIPTION,'&'||'#63;')>0 ;
 
--    ?   &#63;        
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#64;','@') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#64;','@'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#64;')>0 or
INSTR(DESCRIPTION,'&'||'#64;')>0 ;
                     
--   [   &#91;  opening bracket      
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#91;','[') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#91;','['),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#91;')>0 or
INSTR(DESCRIPTION,'&'||'#91;')>0 ;  
           
--   \   &#92;  backslash      
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#92;','\') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#92;','\'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#92;')>0 or
INSTR(DESCRIPTION,'&'||'#92;')>0  ; 
           
--  ]   &#93;  closing bracket      
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#93;',']') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#93;',']'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#93;')>0 or
INSTR(DESCRIPTION,'&'||'#93;')>0 ; 
           
--  ^  &#94;  caret - circumflex     
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#94;','^') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#94;','^'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#94;')>0 or
INSTR(DESCRIPTION,'&'||'#94;')>0  ;  
           
           
--  {  &#123;  opening brace     
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#123;','{') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#123;','{'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#123;')>0 or
INSTR(DESCRIPTION,'&'||'#123;')>0 ;  
         
         
--  {  &#123;  opening brace     
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#124;','{') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#124;','|'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#124;')>0 or
INSTR(DESCRIPTION,'&'||'#124;')>0 ;          
           
--  {  &#125;  closing brace    
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#125;','}') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#125;','}'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#125;')>0 or
INSTR(DESCRIPTION,'&'||'#125;')>0  ;                       

--  ~  &#125;  equivalency sign - tilde    
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#126;','~') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#126;','~'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#126;')>0 or
INSTR(DESCRIPTION,'&'||'#126;')>0  ;  
         
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#191;','') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#191;',''),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#191;')>0 or
INSTR(DESCRIPTION,'&'||'#191;')>0  ;  
         
--  °  &#176;    degree sign
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#176;','°') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#176;','°'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#176;')>0 or
INSTR(DESCRIPTION,'&'||'#176;')>0 ;  
           
--  ±  &#177;  plus-or-minus sign   
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#177;','±') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#177;','±'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#177;')>0 or
INSTR(DESCRIPTION,'&'||'#177;')>0 ;  
--  ² &#178;  superscript two - squared    
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#178;','²') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#178;','²'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#178;')>0 or
INSTR(DESCRIPTION,'&'||'#178;')>0 ;
             
--  ³  &#179;  superscript three - cubed   
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#179;','³') ,
DESCRIPTION=replace(DESCRIPTION,'&'||'#179;','³'),            
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#179;')>0 or
INSTR(DESCRIPTION,'&'||'#179;')>0;  
           
--  µ  &#181;   micro sign  
UPDATE CD_VMS set short_meaning=replace(short_meaning,'&'||'#181;','µ') ,                              
DESCRIPTION=replace(DESCRIPTION,'&'||'#181;','µ'),                                 
date_modified=v_date, modified_by='DWARZEL'
where INSTR(short_meaning,'&'||'#181;')>0 or
INSTR(DESCRIPTION,'&'||'#181;')>0  ;  
         
           
 update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning=  replace(short_meaning,'&'||'#x61;','a'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x61;','a')
where INSTR(DESCRIPTION,'&'||'#x61;')>0 or
INSTR(short_meaning,'&'||'#x61;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning=replace(short_meaning,'&'||'#x62;','b'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x62;','b')
where INSTR(DESCRIPTION,'&'||'#x62;')>0 or
INSTR(short_meaning,'&'||'#x62;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning=  replace(short_meaning,'&'||'#x63;','c'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x63;','c')
where INSTR(DESCRIPTION,'&'||'#x63;')>0 or
INSTR(short_meaning,'&'||'#x63;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning=replace(short_meaning,'&'||'#x64;','d'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x64;','d')
where INSTR(DESCRIPTION,'&'||'#x64;')>0 or
INSTR(short_meaning,'&'||'#x64;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning=replace(short_meaning,'&'||'#x69;','i'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x69;','i')
where INSTR(DESCRIPTION,'&'||'#x69;')>0 or
INSTR(short_meaning,'&'||'#x69;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning=replace(short_meaning,'&'||'#x6a;','j'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x6a;','j')
where INSTR(DESCRIPTION,'&'||'#x6a;')>0 or
INSTR(short_meaning,'&'||'#x6a;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#x70;','p'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x70;','p')
where INSTR(DESCRIPTION,'&'||'#x70;')>0 or
INSTR(short_meaning,'&'||'#x70;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning=replace(short_meaning,'&'||'#x72;','r'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x72;','r')
where INSTR(DESCRIPTION,'&'||'#x72;')>0 or
INSTR(short_meaning,'&'||'#x72;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning=replace(short_meaning,'&'||'#x73;','s'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x73;','s')
where INSTR(DESCRIPTION,'&'||'#x73;')>0 or
INSTR(short_meaning,'&'||'#x73;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning=replace(short_meaning,'&'||'#x74;','t'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x74;','t')
where INSTR(DESCRIPTION,'&'||'#x74;')>0 or
INSTR(short_meaning,'&'||'#x74;')>0 ;
...
short_meaning=replace(short_meaning,'&'||'#x76;','v'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x76;','v')
where INSTR(DESCRIPTION,'&'||'#x76;')>0 or
INSTR(short_meaning,'&'||'#x76;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning=replace(short_meaning,'&'||'#x3a;',':'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x3a;',':')
where INSTR(DESCRIPTION,'&'||'#x3a;')>0 or
INSTR(short_meaning,'&'||'#x3a;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#x28;','('),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x28;','(')
where INSTR(DESCRIPTION,'&'||'#x28;')>0 or
INSTR(short_meaning,'&'||'#x28;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#x29;',')'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#x29;',')')
where INSTR(DESCRIPTION,'&'||'#x29;')>0 or
INSTR(short_meaning,'&'||'#x29;')>0 ;
...
short_meaning= replace(short_meaning,'&'||'#8804;','<='),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#8804;','<=')
where INSTR(DESCRIPTION,'&'||'#8804;')>0 or
INSTR(short_meaning,'&'||'#8804;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#8805;','>='),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#8805;','>=')
where INSTR(DESCRIPTION,'&'||'#8805;')>0 or
INSTR(short_meaning,'&'||'#8805;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#8800;','<>'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#8800;','<>')
where INSTR(DESCRIPTION,'&'||'#8800;')>0 or
INSTR(short_meaning,'&'||'#8800;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#8223;',''''),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#8223;','''')
where INSTR(DESCRIPTION,'&'||'#8223;')>0 or
INSTR(short_meaning,'&'||'#8223;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#8322;','²'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#8322;','²')
where INSTR(DESCRIPTION,'&'||'#8322;')>0 or
INSTR(short_meaning,'&'||'#8322;')>0 ;

/*  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#945;','alpha'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#945;','alpha')
where INSTR(DESCRIPTION,'&'||'#945;')>0 or
INSTR(short_meaning,'&'||'#945;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#946;','beta'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#946;','beta')
where INSTR(DESCRIPTION,'&'||'#946;')>0 or
INSTR(short_meaning,'&'||'#946;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#947;','gamma'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#947;','gamma')
where INSTR(DESCRIPTION,'&'||'#947;')>0 or
INSTR(short_meaning,'&'||'#947;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#948;','delta'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#948;','delta')
where INSTR(DESCRIPTION,'&'||'#948;')>0 or
INSTR(short_meaning,'&'||'#948;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#954;','lambda'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#954;','lambda')
where INSTR(DESCRIPTION,'&'||'#954;')>0 or
INSTR(short_meaning,'&'||'#954;')>0 ;

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#955;','kappa'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#955;','kappa')
where INSTR(DESCRIPTION,'&'||'#955;')>0 or
INSTR(short_meaning,'&'||'#955;')>0 ;
...
where INSTR(DESCRIPTION,'&'||'#223;')>0 or
INSTR(short_meaning,'&'||'#223;')>0 ;


 update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#65256;','red color'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#65256;','red color')
where INSTR(DESCRIPTION,'&'||'#65256;')>0 or
INSTR(short_meaning,'&'||'#65256;')>0 ;

 update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#8594;','rightwards arrow'),
DESCRIPTION= replace(DESCRIPTION,'&'||'#8594;','rightwards arrow')
where INSTR(DESCRIPTION,'&'||'#8594;')>0 or
INSTR(short_meaning,'&'||'#8594;')>0 ;

 update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#8596;','left right arrow'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#8596;','left right arrow')
where INSTR(DESCRIPTION,'&'||'#8596;')>0 or
INSTR(short_meaning,'&'||'#8596;')>0 ;

 update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#3425;','LL'),
DESCRIPTION=replace(DESCRIPTION,'&'||'#3425;','LL')
where INSTR(DESCRIPTION,'&'||'#3425;')>0 or
INSTR(short_meaning,'&'||'#3425;')>0 ;*/

  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#956;','µ'),
DESCRIPTION=  replace(DESCRIPTION,'&'||'#956;','µ')
where INSTR(DESCRIPTION,'&'||'#956;')>0 or
INSTR(short_meaning,'&'||'#956;')>0 ;
      
  update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#8200;',' '),
DESCRIPTION=replace(DESCRIPTION,'&'||'#8200;',' ')
where INSTR(DESCRIPTION,'&'||'#8200;')>0 or
INSTR(short_meaning,'&'||'#8200;')>0 ;     

 update CD_VMS  set  date_modified=v_date, modified_by='DWARZEL',
short_meaning= replace(short_meaning,'&'||'#8236;',' '),
DESCRIPTION=replace(DESCRIPTION,'&'||'#8236;',' ')
where INSTR(DESCRIPTION,'&'||'#8236;')>0 or
INSTR(short_meaning,'&'||'#8236;')>0 ;                                                                               
 commit;
 ...
 EXCEPTION
    ...
    errmsg := substr(SQLERRM,1,2000);
         dbms_output.put_line('errmsg  - '||errmsg);
        insert into SBREXT.CT_FB_SPCHAR_ERROR_LOG VALUES('CT_FIX_CD_VMS',   sysdate ,errmsg);
...
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'lt;','<') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'lt;','<'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'lt;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'lt;')>0 ;
         
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#60;','<') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#60;','<'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#60;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#60;')>0 ;        
         
--3  replace '&amp;' by '<'
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'amp;','&') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'amp;','&'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'amp;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'amp;')>0  ;
         
--3  replace '&amp;' by '<'
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#38;','&') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#38;','&'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#38;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#38;')>0  ;        
         
 
---   replace &#32; by '  '    
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#32;',' '),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#32;',' '),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#32;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#32;')>0 ;   
                    
---   replace &#33; by !        
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#33;','!'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#33;','!'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#33;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#33;')>0 ;    
         
---   replace &#34; by "       
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#34;','"'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#34;','"'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#34;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#34;')>0 ;                  
         
-- 4   $    &#35; 
           
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#35;','#'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#35;','#'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#35;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#35;')>0  ; 
           
-- 5   $    &#36; 
           
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#36;','$'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#36;','$'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#36;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#36;')>0 ; 
--6    %   &#37;          
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#37;','%'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#37;','%'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#37;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#37;')>0 ; 
         
--6    &#39;    single quote      
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#39;',''''),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#39;',''''),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#39;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#39;')>0 ;         
             
           
-- 7   (   &#40; 
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#40;','('),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#40;','('),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#40;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#40;')>0 ;
--    )   &#41; 
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#41;',')'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#41;',')'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#41;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#41;')>0 ;          
                             
--    *   &#42; 
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#42;','*'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#42;','*'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#42;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#42;')>0 ;  
           
--    +    &#43; 
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#43;','+'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#43;','+'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#43;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#43;')>0 ;  
           
--    -    &#45; 
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#45;','-'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#45;','-'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#45;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#45;')>0 ;     
         
            
--    '.'    &#46; 
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#46;','.'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#46;','.'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#46;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#46;')>0 ;            
         
--    /    &#47; 
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#47;','/'),
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#47;','/'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#47;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#47;')>0  ;
--    =    &#61;        
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#61;','=') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#61;','='),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#61;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#61;')>0  ; 
           
--    ?   &#63;        
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#63;','?') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#63;','?'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#63;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#63;')>0 ;
 
--    ?   &#63;        
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#64;','@') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#64;','@'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#64;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#64;')>0 ;
                     
--   [   &#91;  opening bracket      
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#91;','[') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#91;','['),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#91;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#91;')>0 ;  
           
--   \   &#92;  backslash      
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#92;','\') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#92;','\'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#92;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#92;')>0  ; 
           
--  ]   &#93;  closing bracket      
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#93;',']') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#93;',']'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#93;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#93;')>0 ; 
           
--  ^  &#94;  caret - circumflex     
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#94;','^') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#94;','^'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#94;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#94;')>0  ;  
           
           
--  {  &#123;  opening brace     
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#123;','{') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#123;','{'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#123;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#123;')>0 ;  
         
         
--  {  &#123;  opening brace     
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#124;','{') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#124;','|'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#124;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#124;')>0 ;          
           
--  {  &#125;  closing brace    
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#125;','}') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#125;','}'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#125;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#125;')>0  ;                       

--  ~  &#125;  equivalency sign - tilde    
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#126;','~') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#126;','~'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#126;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#126;')>0  ;  
         
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#191;','') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#191;',''),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#191;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#191;')>0  ;  
         
--  °  &#176;    degree sign
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#176;','°') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#176;','°'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#176;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#176;')>0 ;  
           
--  ±  &#177;  plus-or-minus sign   
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#177;','±') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#177;','±'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#177;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#177;')>0 ;  
--  ² &#178;  superscript two - squared    
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#178;','²') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#178;','²'),
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#178;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#178;')>0 ;
             
--  ³  &#179;  superscript three - cubed   
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#179;','³') ,
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#179;','³'),            
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#179;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#179;')>0;  
           
--  µ  &#181;   micro sign  
UPDATE PROPERTIES_EXT set LONG_NAME=replace(LONG_NAME,'&'||'#181;','µ') ,                              
PREFERRED_DEFINITION=replace(PREFERRED_DEFINITION,'&'||'#181;','µ'),                                 
date_modified=v_date, modified_by='DWARZEL'
where INSTR(LONG_NAME,'&'||'#181;')>0 or
INSTR(PREFERRED_DEFINITION,'&'||'#181;')>0  ;  
...
INSTR(LONG_NAME,'&'||'#8236;')>0 ;                                                                               
 ...
 EXCEPTION
    ...
    errmsg := substr(SQLERRM,1,2000);
     ...
     commit; 
END CT_FIX_PROPERTIES_EXT;
/
exec SBREXT.CT_FIX_SPCHAR_VV_ATT_EXT;
exec SBREXT.CT_FIX_QUEST_CONTENTS_EXT;
exec SBR.CT_FIX_SP_CHAR_PV;
exec SBR.CT_FIX_SP_CHAR_VM;
exec SBR.CT_FIX_VALUE_DOMAINS;
exec SBR.CT_FIX_CD_VMS;
exec SBR.CT_FIX_REF_DOC;
exec SBREXT.CT_FIX_PROPERTIES_EXT;