...
/
CREATE OR REPLACE SYNONYM SBREXT.MDSR_STANDARD_FORM_CDE_TYPE FOR  MDSR_STANDARD_FORM_CDE_TYPE

/
GRANT SELECT  ON MDSR_STANDARD_FORM_CDE_TYPE TO PUBLIC
...
FROM SBREXT.MDSR_STANDARD_FORM_CDE_TYPE GROUP BY MODULE_TYPE,
   ...
   CDE_ID;
/
CREATE OR REPLACE SYNONYM SBREXT.MDSR_STANDARD_FORM_CDE_AGR FOR MDSR_STANDARD_FORM_CDE_AGR

/
GRANT SELECT  ON MDSR_STANDARD_FORM_CDE_AGR TO PUBLIC
