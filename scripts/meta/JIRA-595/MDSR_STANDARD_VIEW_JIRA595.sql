...
SPOOL CC-FORMBUILD-595-Views.log
CREATE OR REPLACE VIEW SBREXT.MDSR_STANDARD_FORM_CDE_TYPE
(
   MODULE_TYPE,
   MODULE_ORDER,
   FORM_ID_VERSION,
...
/
GRANT SELECT ON MDSR_STANDARD_FORM_CDE_TYPE TO READONLY
/
GRANT SELECT ON MDSR_STANDARD_FORM_CDE_TYPE TO DER_USER
/
GRANT SELECT ON MDSR_STANDARD_FORM_CDE_TYPE TO SBR
/
CREATE OR REPLACE VIEW SBREXT.MDSR_STANDARD_FORM_CDE_AGR
...
FROM SBREXT.MDSR_STANDARD_FORM_CDE_TYPE GROUP BY MODULE_TYPE,
   MODULE_ORDER,
   CDE_ID,
   DE_VERSION,
   DE_NAME
...
/
GRANT SELECT ON MDSR_STANDARD_FORM_CDE_AGR TO READONLY
/
GRANT SELECT ON MDSR_STANDARD_FORM_CDE_AGR TO DER_USER
/
GRANT SELECT ON MDSR_STANDARD_FORM_CDE_AGR TO SBR
/
SPOOL OFF
