 create or replace view MDSR_759XML_VIEW
...
order by  CS_ID) AS MDSR759_XML_CS_LIST_T1)   "ClassificationList"
 FROM 
 (select distinct 
    CS_CONTEXT_NAME,
    ...
    order by CS_CONTEXT_NAME
     )con
     
     
     select* from MDSR_759XML_VIEW