...
drop type MDSR_FB_DATA_EL_XML_T;--MDSR_FB_DATA_EL_XML_T 
...
(   
  ...
  "dataElementDerivation"  MDSR_FB_COM_DE_DR_XML_LIST_T, 
...
"dataElement"       MDSR_FB_DATA_EL_XML_T,
...
CREATE OR REPLACE TYPE          MDSR_FB_VDC_DR_XML_T    AS OBJECT  --8
(   
  "nciTermBrowserLink"      varchar2(255)
);

CREATE OR REPLACE TYPE          MDSR_FB_VD_DR_XML_T    AS OBJECT  --8
(   
  "shortName"      varchar2(255),
  "type"        varchar2 (50),
  "workflowStatus"         varchar2 (20), 
  "valueDomainConcept"  MDSR_FB_VDC_DR_XML_T
);


CREATE OR REPLACE TYPE          MDSR_FB_DE_DR_XML_T    AS OBJECT  --8
(   
  "publicId"         number,
  "version"                number (4,2),  
  "valueDomain"    MDSR_FB_VD_DR_XML_T  
);

CREATE OR REPLACE TYPE          MDSR_FB_COM_DE_DR_XML_T    AS OBJECT  --8
(   
  "usageCategory"  MDSR_FB_USECAT_XML,
  "displayOrder"         number, 
  "valueDomain"     MDSR_FB_DE_DR_XML_T  
);
CREATE OR REPLACE TYPE     MDSR_FB_COM_DE_DR_XML_LIST_T     as table of MDSR_FB_COM_DE_DR_XML_T;
<dataElementDerivation>
   ...
   select MDSR_FB_USECAT_XML('Mandatory','') ,
                      '0' ,
                     MDSR_FB_DE_DR_XML_T(
                     '0',
                     '0',
          MDSR_FB_VD_DR_XML_T(
                    ...
                    'NonEnumerated'   ,
                    'RELEASED'       ,
                    MDSR_FB_VDC_DR_XML_T('http://blankNode' ) ) ) DE
from SBR.COMPLEX_DATA_ELEMENTS cdv,
       ...
       )as MDSR_FB_COM_DE_DR_XML_LIST_T)
       from dual
