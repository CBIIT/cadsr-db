    SELECT MM.DISPLAY_ORDER,
                         ...
                         CAST (
                            MULTISET (
                                        ...
                                        MDSR_FB_DATA_EL_XML_T (
                                           ...
                                           MULTISET (
                                                SELECT TRIM (DISPLAY_ORDER),
                                                 ...
                                                 ORDER BY DISPLAY_ORDER) AS MDSR_FB_VV_XML_LIST_T) as L_VV
                                         
                                   --select *from SBREXT.MDSR_FB_QUESTION_MVW QQ
                               ...
                               ORDER BY QQ.DISPLAY_ORDER) AS MDSR_FB_QUESTION_XML_LIST_T)
                            AS Question_LIST
                    FROM SBREXT.MDSR_FB_QUEST_MODULE_MVW mm
                   WHERE --mf.qc_IDSEQ = mm.CRF_IDSEQ and
                    mm.mod_idseq='430203EE-CCBA-6162-E053-F662850A2532'
                --and mod_id=2263416
