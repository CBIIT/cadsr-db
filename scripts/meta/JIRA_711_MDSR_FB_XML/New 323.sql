                                           ...
                                           CAST (
                                              MULTISET (
                                                 SELECT           --1 data set
                                                  ...
                                                  WHERE vd.vd_idseq = qq.vd_idseq) AS MDSR_FB_VD_XML_LIST_T) as PV
                                                ...
                                                and de.DE_IDSEQ=qq.DE_IDSEQ) as MDSR_FB_COM_DE_DR_XML_LIST_T) as "derivation"
                                           ...
                                           CAST (
                                              MULTISET (
                                               ...
                                               WHERE   RD.RD_IDSEQ =RB.RD_IDSEQ (+)
                                                     ...
                                                     AND rd.ac_idseq =qq.de_idseq) as MDSR_FB_RD_XML_LIST_T) as "REFDOC"
                                                ,
