...
,"type"              VARCHAR2(5) 
,"headerInstruction"     SBREXT.MDSR_INSTRUCTIONS_T                 
,"footerInstruction"     SBREXT.MDSR_INSTRUCTIONS_T  
...
AS
   SELECT cf.name "context",
          ...
          FR.QTL_NAME "type",
          SBREXT.MDSR_INSTRUCTIONS_T (FI.preferred_definition),
          SBREXT.MDSR_INSTRUCTIONS_T (FF.preferred_definition),
          CAST (
             MULTISET (
