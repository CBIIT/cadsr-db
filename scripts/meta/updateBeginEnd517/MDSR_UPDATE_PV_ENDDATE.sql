CREATE OR REPLACE PROCEDURE SBR.MDSR_UPDATE_PV_ENDDATE(p_vd_ID IN number,p_ver in varchar,p_value in varchar ,p_date in varchar)
AS
...
begin
 ...
 EXCEPTION
    ...
    insert into MDSR_PV_ERR (COMMENTS,DATE_PROCESSED) VALUES (errmsg, sysdate);
