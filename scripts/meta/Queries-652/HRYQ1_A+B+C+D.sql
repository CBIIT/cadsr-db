 -- SELECT count(*),DE_PublicId from(
  ...
  SELECT dde.CONCEPT_NAME CONCEPT_NAME,dde.CONCEPT_CODE,dde.CONCEPT_PUBLIC_ID,
          ...
          DEC.REGISTRATION_STATUS DEC_REGISTRATION_STATUS,
...
and Q.DE_IDSEQ = de.de_idseq ) AS HARMONY_FORM_CDE_LIST_T) FORMS,
             ...
             MULTISET (
                SELECT des_conte.NAME,
                 ...
                 WHERE     de.de_idseq = des.AC_IDSEQ(+)
                       AND des.conte_idseq = des_conte.conte_idseq(+)) AS HARMONY_DESIGN_LIST_T)
             ...
             MULTISET (
                SELECT def_conte.NAME,
                 ...
                 WHERE     de.de_idseq = def.AC_IDSEQ(+)
                       AND def.conte_idseq = def_conte.conte_idseq(+)) AS HARMONY_DEF_LIST_T)
             Alt_Definition ,
               CAST (
             MULTISET (
                SELECT rd_conte.NAME,
                 ...
                 WHERE     de.de_idseq = rd.AC_IDSEQ(+)
                       AND rd.conte_idseq = rd_conte.conte_idseq(+)) AS HARMONY_DOC_REF_LIST_T)
