   SELECT de.de_idseq ,
          ...
          CON_ID VD_CONCEPT_PUBLIC_ID,C.PREFERRED_NAME VD_CONCEPT_CODE,C.LONG_NAME VD_CONCEPT_NAME,
...
SBR.contexts vd_conte 
  ...
  AND (UPPER(C.LONG_NAME)= UPPER(replace('Time Point',' '))or CON_ID=2436950 or C.PREFERRED_NAME='C68568')
